...
Global Const $sVersion = "DW Sender 0.1.0.4"
...
; Общее
$sWID = IniRead($sPath_ini, "Global", "wid", "190000")

; НАСТРОЙКИ расположения файлов РПО
Global Const $sFileLoad = IniRead($sPath_ini, "Global", "rpo_dir", "C:\rpo_out\")
; Архив с файлами выборки
Global Const $sFileArchiv = IniRead($sPath_ini, "Global", "rpo_temp_dir", "C:\rpo_tmp_dw\")
...
; EMAIL
; От кого, имя
$sFromName = $sWID & "_DW@moscowpost.ru"
; От кого, адрес
